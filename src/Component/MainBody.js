    ...
    <div className="container">
      <div className="row justify-content-center">
        <div className="col-md-9">
          ...
          <div className="my-3">
            <SmoothProgressBar  value="15"  num="15"/>
          </div>
            ...
            <ul className="deal-list">
              <li>
                ...
                <label className="form-check-labels" htmlFor="provider">
                    <Link to="/Step1"><img src="img/three.svg" alt="" className="radio_img" /> </Link>
                </label>
              </li>
              <li>
                <input
                ...
                />
                <label className="form-check-labels" htmlFor="provider">
                    <Link to="/Step1"><img src="img/sky.svg" alt="" className="radio_img" /></Link>
              ...
              <li>
                ...
                />
                <label className="form-check-labels" htmlFor="provider">
                <Link to="/Step1"><img src="img/ee.svg" alt="" className="radio_img" /></Link>
              ...
              <li>
                ...
                />
                <label className="form-check-labels" htmlFor="provider">
                <Link to="/Step1"> <img src="img/o2.svg" alt="" className="radio_img" /></Link>
              ...
              <li>
                ...
                />
                <label className="form-check-labels" htmlFor="provider">
                <Link to="/Step1"><img src="img/voda.svg" alt="" className="radio_img" /></Link>
              ...
              <li>
                ...
                />
                <label className="form-check-labels" htmlFor="provider">
                      <Link to="/Step1"> <img src="img/gg.svg" alt="" className="radio_img" /></Link>
              ...
              <li>
                ...
                />
                <label className="form-check-labels" htmlFor="provider">
                <Link to="/Step1"> <p className="mb-0 radio-title">Others</p></Link>
              ...
              <li>
                ...
                />
                <label className="form-check-labels" htmlFor="provider">
                <Link to="/Step1"><p className="mb-0 radio-title">
                    I Do Not <br />
                    Have One
                  </p></Link>
